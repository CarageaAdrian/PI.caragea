...
public class Controller1 extends Main{
    ...
    public boolean validateLogin(){
        ...
        String verifyLogin = "SELECT count(1) FROM useraccounts where username = '" + usernameTextField.getText() + "' AND password = '" + ControllerRegister.EncryptPassword.encryptPassword(passwordPasswordField.getText()) + "'";
    ...
    public boolean validateLoginUser(){
        DatabaseConnection connectNow = new DatabaseConnection();
        Connection connectDB = connectNow.getConnection();
        String verifyLogin = "SELECT count(1) FROM NormalUserAccounts where username = '" + usernameTextField.getText() + "' AND password = '" + ControllerRegister.EncryptPassword.encryptPassword(passwordPasswordField.getText())   + "'";
        ...
        try{
            ...
            while(queryResult.next()){
                if(queryResult.getInt(1) == 1){
                    ...
                    String aux = "SELECT idUserAccounts FROM NormalUserAccounts where username = '" + usernameTextField.getText() + "' AND password = '" + ControllerRegister.EncryptPassword.encryptPassword(passwordPasswordField.getText()) + "'";
